...
- Export packet preview that generates browser-downloadable Markdown and JSON
  ...
  hash metadata included in Markdown exports.
...
- Evidence packet coverage for source media metadata in Markdown exports
  alongside JSON source media records.
...
- Latest evidence packet metadata coverage verified source media duration,
  detected-start, file-size, and hash metadata are included in Markdown exports.
