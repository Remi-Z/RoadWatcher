...
## Approved FFmpeg Consent Identity

The catalog's FFmpeg digest is SHA-256 of this UTF-8 identity:

`Gyan FFmpeg 8.1.1 full build|GPL-3.0-or-later and bundled static library notices|https://ffmpeg.org/legal.html|https://github.com/GyanD/codexffmpeg/releases/tag/8.1.1|49b28c5f16addd40239a66949973458769b7056fb7752c30ac0d53389d09a552`

Setup Center requires that exact consent before downloading. The fixed backend
strategy accepts no archive URL, executable path, version probe, or install path
from the frontend.
...
build configuration match the real Windows smoke. The owner's software-library
approval closes the decision gate for this exact app-local download; runtime
consent and retained GPL/source notices remain mandatory.
