...
| Reproducible York/ONNX release-asset production | Strict York boundary/OSM/config/tool recipe, coverage validation, fixed bounded commands, deterministic archive and verified manifest publication; catalog placeholders | York builder proven with fake tools; real approved inputs and ONNX builder still missing |
