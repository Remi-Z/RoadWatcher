...
- Unit: virtual-timeline gap/offset/drift math including a 240-clip/four-hour fixture, one-hertz four-hour GPX interpolation, acceleration, incident validation, bounded geocoding/thumbnail/proxy caches, and manifest hashes.
...
- Manual: LibVLC hardware decode and proxy preparation with representative 4K60 HEVC, disconnected source recovery, offline map behaviour, long-ride cache bounds.
