...
- Unit: virtual-timeline gap/offset/drift math including a 240-clip/four-hour fixture, one-hertz four-hour GPX interpolation, acceleration, incident validation, bounded caches, and manifest hashes.
